...
function App() {
  ...
  const contents1 = [
    "Tally Prime is an accounting software platform designed for small and medium-sized businesses to efficiently manage their financial and accounting operations.",
